...
module.exports.Class = function (/*{superclass}, proto*/) {
    ...
    // We impose these bits onto the prototype, no matter what.
    var imposed_proto = {
        superclass: supr,
        _super: function (name, args) {
            if (!this.superclass) { return; }
            return this.superclass.prototype[name].apply(this, args);
        }
    };
    ...
    _.extend(cls.prototype, def_proto, supr_proto, proto, imposed_proto);
