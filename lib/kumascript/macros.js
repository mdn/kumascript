...
var MacroProcessor = ks_utils.Class({
    ...
    process: function (src, api_ctx, process_done) {
        ...
        api_ctx.performAutoRequire(function (err) {
            ...
            $this.loadTemplates(loader, templates, function (tmpl_errors) {
                // Evaluate all the macros....
                $this.evaluateMacros(api_ctx, templates, macros, function (macro_errors) {
    ...
    // #### Load templates
    loadTemplates: function (loader, templates, next_cb) {
        var $this = this,
            errors = [],
    ...
    // #### Evaluate macros
    evaluateMacros: function (api_ctx, templates, macros, next_cb) {
        var $this = this,
            errors = [],
