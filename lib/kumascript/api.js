...
var APIContext = ks_utils.Class({
     ...
     *
     * @param {function(Error|null):void} next
     */
     ...
     * @param {string} key
     * @param {number} tm_out
     * @param {function(function(any):void):void} to_cache
     */
 ...
 *
 * Node 6 now supports proxies without any feature flags and Kuma uses Node 8,
