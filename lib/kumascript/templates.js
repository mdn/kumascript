    ...
    execute: function (args, ctx, next) {
        ...
        Fiber(function () {
            try {
                ...
                util.debug("ARGH " + util.inspect(e));
...
// ### KumaEJSTemplate
//
// An EJS template with dirty hacks to work with Kuma quirks
var KumaEJSTemplate = ks_utils.Class(EJSTemplate, {
    initialize: function (options) {
        BaseTemplate.prototype.initialize.apply(this, arguments);
...
module.exports = {
    ...
    KumaEJSTemplate: KumaEJSTemplate
};
