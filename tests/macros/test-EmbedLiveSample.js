...
describeMacro('EmbedLiveSample', function () {
    ...
    itMacro('One argument: ID', function (macro) {
        ...
        return assert.eventually.equal(
            ...
            '<iframe title="Live Sample." class="live-sample-frame sample-code-frame"' +
    ...
    itMacro('Six arguments: ID, width, height, "", "", class', function (macro) {
        ...
        return assert.eventually.equal(
            ...
            '<iframe title="Live Sample." class="live-sample-frame nobutton"' +
    ...
    itMacro('Six arguments: ID, width, height, "", "", XSS attempt (failed)', function (macro) {
        ...
        return assert.eventually.equal(
            ...
            '<iframe title="Live Sample." class="live-sample-frame &#34;&gt;&lt;script&gt;alert(&#34;XSS&#34;);&lt;/script&gt;"' +
            ' id="frame_sampleNone" frameborder="0"' +
            ' width="100" height="50"' +
            ' src="https://mdn.mozillademos.org/en-US/docs/Web/CSS/-moz-appearance$samples/sampleNone?revision=1402877">' +
            '</iframe>'
