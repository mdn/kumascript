      ...
      '<table class="properties">',
        '<tbody>',
          ...
          '<tr>',
            ...
            '<td>', permittedContent.join('<br/>'), '</td>',
          // '</tr>',
        '</tbody>',
      '</table>'
    ];
...
const MOCK_PAGES = {
    'en-US': {
        'a': {
            ...
            data: {
                summary: "This is a mock for the SVG <strong><code>&lt;a&gt;</code></strong> element.",
                tags: ["SVG", "Element"]
            }
        },
        "altGlyphDef": {
            ...
            data: {
                summary: "This is a mock for the SVG <strong><code>altGlyphDef</code></strong> element.",
                tags: ["SVG", "Element"]
            }
        },
        "clipPath": {
            ...
            data: {
                summary: "This is a mock for the SVG <strong><code>clipPath</code></strong> element.",
                tags: ["SVG", "Element"]
            }
        },
        "color-profile": {
            ...
            data: {
                summary: "This is a mock for the SVG <strong><code>color</code></strong> element.",
                tags: ["SVG", "Element"]
            }
        },
        "cursor": {
            ...
            data: {
                summary: "This is a mock for the SVG <strong><code>cursor</code></strong> element.",
                tags: ["SVG", "Element"]
            }
        },
        "filter": {
            ...
            data: {
                summary: "This is a mock for the SVG <strong><code>filter</code></strong> element.",
                tags: ["SVG", "Element"]
            }
        },
        "font": {
            ...
            data: {
                summary: "This is a mock for the SVG <strong><code>font</code></strong> element.",
                tags: ["SVG", "Element"]
            }
        },
        "font-face": {
        ...
        "foreignObject": {
            ...
            data: {
                summary: "This is a mock for the SVG <strong><code>foreignObject</code></strong> element.",
                tags: ["SVG", "Element"]
            }
        },
        "image": {
            ...
            data: {
                summary: "This is a mock for the SVG <strong><code>image</code></strong> element.",
                tags: ["SVG", "Element"]
            }
        },
        "marker": {
            ...
            data: {
                summary: "This is a mock for the SVG <strong><code>marker</code></strong> element.",
                tags: ["SVG", "Element"]
            }
        },
        "mask": {
            ...
            data: {
                summary: "This is a mock for the SVG <strong><code>mask</code></strong> element.",
                tags: ["SVG", "Element"]
            }
        },
        "pattern": {
            ...
            data: {
                summary: "This is a mock for the SVG <strong><code>pattern</code></strong> element.",
                tags: ["SVG", "Element"]
            }
        },
        "script": {
            ...
            data: {
                summary: "This is a mock for the SVG <strong><code>script</code></strong> element.",
                tags: ["SVG", "Element"]
            }
        },
        "style": {
            ...
            data: {
                summary: "This is a mock for the SVG <strong><code>style</code></strong> element.",
                tags: ["SVG", "Element"]
            }
        },
        "switch": {
            ...
            data: {
                summary: "This is a mock for the SVG <strong><code>switch</code></strong> element.",
                tags: ["SVG", "Element"]
            }
        },
        "text": {
            ...
            data: {
                summary: "This is a mock for the SVG <strong><code>text</code></strong> element.",
                tags: ["SVG", "Element"]
            }
        },
        "view": {
            ...
            data: {
                summary: "This is a mock for the SVG <strong><code>view</code></strong> element.",
                tags: ["SVG", "Element"]
            }
        }
    },
    'zh-CN': {
        ...
        "foreignObject": {
            ...
            data: {
                summary: "这是SVG <strong><code>foreignObject</code></strong>元素的模拟",
                tags: ["SVG", "Element"]
            }
        },
        "image": {
